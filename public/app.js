...
const PLACES = [
  ...
  { slug: "solkar-city", name: "Solkar", tag: "Rift events: 0",
    text: "A desert of glass and silicon, holding the largest Astrafer reserve on the Ring and a record with no Rift in it. It is also where the Undefined are least free. Past the canyon bridge, a calm and entirely artificial voice welcomes you to the Museum of Civilization and asks you to observe the data." },
];

/* Percentages are of the map image box, so the pins ride with it at any size. */
const REGIONS = [
  { x: 48.5, y: 58, name: "Aurelion", tag: "Kingdom",
    text: "Golden, faith-run, and the richest kingdom on the Ring in coin. It carries more recorded Rifts than everywhere else put together — and the Crown has no explanation it is willing to publish." },
  { x: 41.5, y: 67.5, name: "Oakhaven", tag: "Kingdom",
    text: "Built around the LumenOak — an ancient tree of crystal and petrified amber carrying a thousand glass leaves. A day and a half from the capital by the Serpent Road, and preparing for a Grand Alignment." },
  { x: 66, y: 67, name: "Caelmarch", tag: "Industrial engine", slug: "caelmarch",
    text: "Cast iron, basalt and agri-vines. It forges what the lit cities live on and takes the soot for them. Torian keeps a workshop here, and the Slag-Heap slum clings to the outside of the wall like something the city could not quite shake off." },
  { x: 82, y: 60, name: "Solkar", tag: "Rift events: 0",
    text: "A desert of glass and silicon holding the largest Astrafer reserve on the Ring, and not one Rift in its record. It is also where the Undefined are least free. Past the canyon bridge a calm, maternal, entirely artificial voice welcomes you to the Museum of Civilization and asks you to observe the data." },
  { x: 18, y: 48, name: "The Sapphire Basin", tag: "Outer kingdom",
    text: "Water, Astrafer and the Great Glass Dam. It hoards all three. Its High Princess rode the Serpent Road to Aurelion under Sun Guard escort — and that journey is where this story begins." },
  { x: 36, y: 25, name: "Wydin", tag: "Unsurveyed",
    text: "The map marks it with a question mark. So does the Archive. Nothing before nine thousand cycles survives anywhere in the record, and this is where the silence is deepest." },
  ...
  { x: 77, y: 31, name: "Wild Kingdom", tag: "Beyond the System",
    text: "East, off-grid: no light towers, no roads, no census — and, like Solkar, not one Rift. It also holds dense deposits of the one ugly grey stone nobody has ever found a use for." },
  { x: 57, y: 70, name: "Serpent Roads", tag: "Main roads",
    text: "A highway that adjusts itself, re-routing away from dead cities and physically recoiling from the scars. Fourteen rotations of wind and stone between outposts, and one rule that never bends: you do not travel them after the light has passed." },
];

const ARTEFACTS = [
  { slug: "astrafer", name: "Astrafer", tag: "Material · restricted",
    text: "Crystalline ore thrown out by the Titanfall impact, nine thousand cycles back. It drinks light over centuries and gives the stored photons back when struck: pale, dormant and cold until it ignites from within. Every Light Credit on the Ring is a claim on a microgram of it, sitting in a sovereign vault." },
  { slug: "twilight-strider", name: "The Twilight-Strider", tag: "Fauna · hostile", wide: true,
    text: "Six-legged, armoured, and perfectly at home in the ravines where the light turns grey. Hunters do not go north for the meat. They go for the horn — clamped, cut and set into a lens, it throws a beam that sees what daylight cannot. Torian will take three, and a Volt-Stalker spine, and give you a bridge between a dead language and a living grid." },
  ...
  { slug: "currency", name: "Currency of the Ringworld", tag: "Two forms of power",
    text: "Light Credits are universal, digital, flawless — and trackable to the last transaction, because that was always the point. Large Ones are struck from regional gold: thick, heavy, imperfect, stamped with King Auron's profile, and quite untraceable. The Crown introduced them deliberately. One is the weight of power. The other is value without weight: a lie that glitters." },
...
const RECORDS = [
  { file: "REC-0001", slug: "erik-swordstrong", name: "Erik Swordstrong", role: "Sun Guard, formerly",
    text: "Captain of the Third Squadron, Sun Guard of Aurelion. His Mark reads: Command and Protection. Service Until Cessation. He tore a strip from his own captain's cape, tied it over his eyes and never took it off — the Mercy Visir. He is not blind. He is choosing not to see, and he hunts by sound, pressure and weight with a grey, ugly blade no smith will claim." },
  ...
  { file: "REC-0005", slug: "king-auron", name: "King Auron", role: "Crown of Aurelion",
    text: "He peels out-of-season fruit while other people burn. A man who looks as though he has never lifted anything heavier than a ledger, which is precisely why he is dangerous: he hears an apocalypse described to him and works out what it can be bought and sold for." },
  ...
  { file: "REC-0007", slug: "lucious", name: "Lucius", role: "The Awakened — do not approach",
    text: "A miner's uniform fused into a fortress of rock and rusted steel. He does not raid; he prosecutes. He puts the Defined on trial outside their own walls and asks them, in front of everyone, what their destiny is actually worth. Their creed is two words long: I matter." },
